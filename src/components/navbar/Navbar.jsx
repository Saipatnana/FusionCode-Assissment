...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      <section
        className={`${navbarStyles.smallNavbar} ${isScrolled ? "bg-[#fffef2]" : "bg-transparent"} absolute w-full`}
      >
        <div className="ml-[10px] cursor-pointer">
          <svg
            aria-labelledby="aesop-:r29:"
        ...
        <div>
          <a href="/">
            <IoSearchOutline color={isScrolled?"#333333":"#ffffff"} />
          </a>
          <a href="/">
            <IoHeartOutline color={isScrolled?"#333333":"#ffffff"}/>
          </a>
          <a href="/" className={`${isScrolled?"text-[#333333]":"text-white"}`}>Cart</a>
          <a href="/">
            <RxHamburgerMenu color={isScrolled?"#333333":"#ffffff"}/>
          </a>
        </div>
      </section>
    </>
